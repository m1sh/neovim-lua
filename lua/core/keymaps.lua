...
keymap.set('n', '<c-p>', '<cmd>Rooter<cr><bar><cmd>Telescope find_files<cr>')
keymap.set('n', '<c-g>', '<cmd>Rooter<cr><bar><cmd>Telescope live_grep<cr>')
keymap.set('n', '<c-s>', '<cmd>Rooter<cr><bar><cmd>Telescope grep_string<cr>')
